...
// This animal-guessing program illustrates the use of the binary tree node
// class.
...
/*******************************************************************************
 * The <CODE>AnimalGuess</CODE> Java application illustrates the use of the
 * binary tree node class is a small animal-guessing game.
 * <p>
 * <dt><b>Java Source Code for this class:</b>
 * <dd> <A HREF="../applications/Animals.java">
 * http://www.cs.colorado.edu/~main/applications/Animals.java </A>
...
public class AnimalGuess
{
	 ...
	 * animal-guessing game. As the game is played, the taxonomy tree grows by
	 * learning new animals. The <CODE>String</CODE> argument (<CODE>args</CODE>)
	 ...
	 * @param <CODE>current</CODE> a reference to the root node of a binary
	 *        taxonomy tree that will be used to play the game.
	 *        <dt><b>Postcondition:</b>
	 *        <dd> The method has played one round of the game, and possibly
	 *        added new information about a new animal.
	 * @exception java.lang.OutOfMemoryError Indicates that there is
	 *            insufficient memory to add new information to the tree.
	 */
	 ...
	 * @param - none
	 * @return a reference to the root of a taxonomy tree with the animals:
	 ...
	 * @param <CODE>current</CODE> a reference to a leaf node of a binary
	 *        taxonomy tree
	 *        <dt><b>Precondition:</b>
	 *        <dd> <CODE>current</CODE> is a reference to a leaf in a binary
	 *        taxonomy tree
	 *        <dt><b>Postcondition:</b>
	 *        <dd> Information has been elicited from the user, and the tree has
	 *        been improved.
	 * @exception OutOfMemoryError Indicates that there is insufficient memory
	 *            to add new information to the tree.
	 */
