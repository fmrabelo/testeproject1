    ...
    implements EmployeeDao
{
	...
	static
	{
		...
		employees.add(new Employee(new Integer(1), "John", "Doe", new Integer(36), new Department(
		    new Integer(100), "Accounting")));
		employees.add(new Employee(new Integer(2), "Bob", "Smith", new Integer(25), new Department(
		    new Integer(300), "Sales")));
		employees.add(new Employee(new Integer(4), "Rick", "Reumann", new Integer(30),
		    new Department(new Integer(400), "HR")));
		employees.add(new Employee(new Integer(3), "Andy", "Ma", new Integer(26), new Department(
		    new Integer(200), "R & D")));
		employees.add(new Employee(new Integer(5), "Tony", "Lee", new Integer(40), new Department(
		    new Integer(300), "Sales")));
