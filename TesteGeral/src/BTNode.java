...
/*******************************************************************************
 * A <CODE>BTNode&lt;<E&gt;</CODE> provides a node for a binary tree. Each
 * node contains a piece of data (which is a reference to an E object) and
 * references to a left and right child. The references to children may be null
 * to indicate that there is no child. The reference stored in a node can also
 * be null.
 * <dl>
 * <dt><b>Limitations:</b>
 * <dd> Beyond <CODE>Int.MAX_VALUE</CODE> elements, <CODE>treeSize</CODE>,
 * is wrong.
 * <dt><b>Java Source Code for this class:</b>
 * <dd> <A HREF="../../../../edu/colorado/nodes/BTNode.java">
...
public class BTNode<E>
{
	...
	/**
	 * Initialize a <CODE>BTNode</CODE> with a specified initial data and
	 ...
	 * @param - none
	 *        <dt><b>Postcondition:</b>
	 *        <dd> The data of this node and all its descendants have been
	 ...
	 *        <dt><b>Postcondition:</b>
	 *        <dd> The data of this node and all its descendants have been
	 *        writeen by <CODE>System.out.println( )</CODE> using a preorder
	 *        traversal.
	 */
	 ...
	 *        <dt><b>Postcondition:</b>
	 *        <dd> The data of this node and all its descendants have been
	 *        writeen by <CODE>System.out.println( )</CODE> using a postorder
	 *        traversal.
	 */
	 ...
	 * each node.
	 * @param <CODE>depth</CODE> the depth of this node (with 0 for root, 1
	 *        for the root's children, and so on)(
	 *        <dt><b>Precondition:</b>
	 *        <dd> <CODE>depth</CODE> is the depth of this node.
	 *        <dt><b>Postcondition:</b>
	 *        <dd> The data of this node and all its descendants have been
	 *        writeen by <CODE>System.out.println( )</CODE> using an inorder
	 *        traversal. The indentation of each line of data is four times its
	 *        depth in the tree. A dash "--" is printed at any place where a
	 ...
	 * @param - none
	 *        <dt><b>Postcondition:</b>
	 *        <dd> The tree starting at this node has had its leftmost node
	 *        removed (i.e., the deepest node that can be reached by following
	 *        left links). The return value is a reference to the root of the
	 *        new (smaller) tree. This return value could be null if the
	 *        original tree had only one node (since that one node has now been
	 *        removed).
	 */
	 ...
	 * @param - none
	 *        <dt><b>Postcondition:</b>
	 *        <dd> The tree starting at this node has had its rightmost node
	 *        removed (i.e., the deepest node that can be reached by following
	 *        right links). The return value is a reference to the root of the
	 *        new (smaller) tree. This return value could be null if the
	 *        original tree had only one node (since that one node has now been
	 *        removed).
	 */
	 ...
	 *        <dt><b>Postcondition:</b>
	 *        <dd> The data of this node has been set to <CODE>newData</CODE>.
	 */
	 ...
	 * @param <CODE>newLeft</CODE> a reference to the node that should appear
	 *        as the left child of this node (or the null reference if there is
	 *        no left child for this node)
	 *        <dt><b>Postcondition:</b>
	 *        <dd> The link to the left child of this node has been set to
	 ...
	 * @param <CODE>newLeft</CODE> a reference to the node that should appear
	 *        as the right child of this node (or the null reference if there is
	 *        no right child for this node)
	 *        <dt><b>Postcondition:</b>
	 *        <dd> The link to the right child of this node has been set to
	 *        <CODE>newRight</CODE>. Any other node (that used to be the
	 *        right child) is no longer connected to this node.
	 */
	...
	/**
	 * Copy a binary tree.
	 * @param <CODE>source</CODE> a reference to the root of a binary tree
	 *        that will be copied (which may be an empty tree where
	 *        <CODE>source</CODE> is null)
	 * @return The method has made a copy of the binary tree starting at
	 *         <CODE>source</CODE>. The return value is a reference to the
	 *         root of the copy.
	 ...
	 * @param <CODE>root</CODE> a reference to the root of a binary tree
